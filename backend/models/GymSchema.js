...
const GymSchema = new Schema({
  ...
  phone: { type: String, required: true, match: [/^\d{10,}$/, "Phone number must be at least 10 digits and numeric"] },
...
GymSchema.index({ name: 'text', 'address.city': 'text', facilities: 'text', description: 'text' });
