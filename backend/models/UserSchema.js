...
const UserSchema = new mongoose.Schema({
    ...
    email : String, 
    password : String,
    role: { type: String, enum: ["customer", "trainer", "owner"], required: true },
    ...
    trainerDetails : {
        contact : String,
        charges : String,
        programmes : { type : String, enum : ["Cardio", "Weightlifting", "Zumba", "CrossFit", "Yoga", "Boxing", "HIIT", "Pilates", "Calisthenics", "Powerlifting", "Bodybuilding", "Olympic Weightlifting", "Kickboxing", "Spinning", "Athletic Conditioning", "Circuit Training", "Martial Arts", "Swimming", "Functional Training"]},
        timeSlots : [],
        approved : false,
